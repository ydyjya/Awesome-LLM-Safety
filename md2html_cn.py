#!/usr/bin/env python3
"""
将subtopic目录中的Markdown文件转换为中文HTML格式，保持与主网站相同的样式。
"""
...
output_dir = os.path.join(base_dir, 'subtopic_html_cn')
    ...
    <header>
        <div class="container">
            ...
            <div class="language-switch">
                ...
                <a href="../index_cn.html" class="active">中文</a>
            </div>
        </div>
    </header>

    <div class="container">
        <a href="../index_cn.html" class="back-to-home">
